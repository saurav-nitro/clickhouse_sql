-- ============================================================
-- Blinkit_Merchant_Weight
-- Merchant's share of daily/weekly sales within each
-- (cdate, categoryid, subcategoryid) bucket.
-- Source: Blinkit_Sales_Weekly
-- ============================================================

CREATE TABLE IF NOT EXISTS Blinkit_Merchant_Weight
(
    cdate                  Date,
    merchantid             String,
    categoryid             String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Blinkit_Merchant_Weight_MV
...
FROM Blinkit_Sales_Weekly AS sw
...
-- Blinkit_Merchant_Weight with all historical data from
-- Blinkit_Sales_Weekly. The MV will handle new inserts
-- going forward automatically.
-- ============================================================

INSERT INTO Blinkit_Merchant_Weight
WITH category_sales AS (
    SELECT
        cdate,
        categoryid,
