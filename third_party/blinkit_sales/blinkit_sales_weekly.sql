-- ============================================================
-- Blinkit_Sales_Weekly
-- Stores daily sales + 7-day rolling average (weekly_sales)
-- Source: Blinkit_Sales + BlinkitMerchant (for cityname)
-- ============================================================

CREATE TABLE IF NOT EXISTS Blinkit_Sales_Weekly
(
    cdate         Date,
    productid     String,
    merchantid    String,
...
INSERT INTO Blinkit_Sales_Weekly
WITH daily_aggregation AS (
    ...
    FROM Blinkit_Sales AS s
    LEFT JOIN BlinkitMerchant AS m
