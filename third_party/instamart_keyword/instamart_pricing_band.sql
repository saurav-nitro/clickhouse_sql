-- ============================================================
-- Instamart_Pricing_Band
-- Per-(cdate, keywordid, productid, cityname) pricing metrics
-- joined from InstamartKeywordRanking_daily × Instamart_Discounting.
--
-- mrp                  = MIN(mrp)                  from Instamart_Discounting
-- city_category_weight = MIN(city_category_weight)
-- weighted_price       = MIN(weighted_price)
-- weighted_discount    = MIN(weighted_discount)
--
-- Source: InstamartKeywordRanking_daily × Instamart_Discounting
-- Destination: Instamart_Pricing_Band
-- ============================================================
...
CREATE TABLE IF NOT EXISTS Instamart_Pricing_Band
(
    cdate                  Date,
    keywordid              String,
    productid              String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Instamart_Pricing_Band_MV
TO Instamart_Pricing_Band
AS
SELECT
    kr.cdate                                AS cdate,
...
-- Instamart_Pricing_Band with all historical data.
-- The MV handles new inserts automatically going forward.
-- ============================================================

INSERT INTO Instamart_Pricing_Band
SELECT
    kr.cdate                                AS cdate,
    kr.keywordid                            AS keywordid,
    kr.productid                            AS productid,
