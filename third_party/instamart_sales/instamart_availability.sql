...
--
-- Source: InstamartProductMerchant_daily  ×  Instamart_Merchant_Weight
-- ============================================================

CREATE TABLE IF NOT EXISTS Instamart_Availability
(
    cdate                  Date,
    productid              String,
    brandid                String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Instamart_Availability_MV
TO Instamart_Availability
AS
WITH merchant_weights AS (
    ...
    FROM Instamart_Merchant_Weight
    GROUP BY
        merchantid,
        categoryid,
        subcategoryid,
...
city_weights AS (
    ...
    FROM InstamartProductMerchant_daily AS p
...
FROM InstamartProductMerchant_daily AS pm
LEFT JOIN merchant_weights AS mw
...
-- Instamart_Availability with all historical data from
-- InstamartProductMerchant_daily. The MV will handle new
-- inserts going forward automatically.
-- ============================================================

INSERT INTO Instamart_Availability
WITH merchant_weights AS (
    SELECT
        merchantid,
        categoryid,
