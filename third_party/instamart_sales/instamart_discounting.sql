...
--
-- Source: InstamartProductMerchant_daily × Instamart_Merchant_Weight × UnitWeight
-- ============================================================
...
CREATE TABLE IF NOT EXISTS Instamart_Discounting
(
    cdate                  Date,
    productid              String,
    cityname               String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Instamart_Discounting_MV
TO Instamart_Discounting
AS
...
-- Instamart_Discounting with all historical data.
-- The MV handles new inserts automatically going forward.
-- ============================================================

INSERT INTO Instamart_Discounting
WITH merchant_weights AS (
    SELECT
        merchantid,
        categoryid,
