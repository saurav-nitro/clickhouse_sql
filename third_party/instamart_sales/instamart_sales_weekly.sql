-- ============================================================
-- Instamart_Sales_Weekly
-- Stores daily sales + 7-day rolling average (weekly_sales)
-- Source: Instamart_Sales + InstamartMerchant (for cityname)
-- ============================================================

CREATE TABLE IF NOT EXISTS Instamart_Sales_Weekly
(
    cdate         Date,
    productid     String,
    merchantid    String,
...
INSERT INTO Instamart_Sales_Weekly
WITH daily_aggregation AS (
    ...
    FROM Instamart_Sales AS s
    LEFT JOIN InstamartMerchant AS m
