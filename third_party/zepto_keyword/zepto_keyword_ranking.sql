...
--
-- Source: ZeptoKeywordRanking × ZeptoProduct × ZeptoMerchant
-- Destination: ZeptoKeywordRanking_daily
-- Excludes combo products (isCombo = 'false').
--
-- Prisma model: ZeptoKeywordRanking
...
--   FROM ZeptoKeywordRanking_daily GROUP BY ...
-- ============================================================
...
CREATE TABLE IF NOT EXISTS ZeptoKeywordRanking_daily
(
    cdate         Date,
    productid     String,
    merchantid    String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS ZeptoKeywordRanking_daily_MV
TO ZeptoKeywordRanking_daily
AS
SELECT
...
FROM ZeptoKeywordRanking AS kr
JOIN ZeptoProduct  AS p ON kr.productId  = p.id
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
...
-- Chunk 1
INSERT INTO ZeptoKeywordRanking_daily
SELECT
    toDate(kr.createdAt)                AS cdate,
    toString(kr.productId)              AS productid,
    toString(kr.merchantId)             AS merchantid,
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-01' AND '2025-01-05'
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-06' AND '2025-01-10'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-11' AND '2025-01-15'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-16' AND '2025-01-20'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-21' AND '2025-01-25'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-01-26' AND '2025-01-31'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-01' AND '2025-02-05'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-06' AND '2025-02-10'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-11' AND '2025-02-15'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-16' AND '2025-02-20'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-21' AND '2025-02-25'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-02-26' AND '2025-02-28'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-01' AND '2025-03-05'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-06' AND '2025-03-10'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-11' AND '2025-03-15'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-16' AND '2025-03-20'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-21' AND '2025-03-25'
GROUP BY cdate, productid, merchantid, keywordid;
...
JOIN ZeptoMerchant AS m ON kr.merchantId = m.id
WHERE p.isCombo = 'false'
  AND toDate(kr.createdAt) BETWEEN '2025-03-26' AND '2025-03-31'
GROUP BY cdate, productid, merchantid, keywordid;

-- ... continue chunks in 5-day intervals up to current date ...
