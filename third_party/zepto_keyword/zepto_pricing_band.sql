...
-- joined from ZeptoKeywordRanking_daily × Zepto_Discounting.
--
-- mrp                  = MIN(mrp)                  from Zepto_Discounting
-- city_category_weight = MIN(city_category_weight)
-- weighted_price       = MIN(weighted_price)
-- weighted_discount    = MIN(weighted_discount)
--
-- Source: ZeptoKeywordRanking_daily × Zepto_Discounting
-- Destination: Zepto_Pricing_Band
-- ============================================================
...
CREATE TABLE IF NOT EXISTS Zepto_Pricing_Band
(
    cdate                  Date,
    keywordid              String,
    productid              String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Zepto_Pricing_Band_MV
TO Zepto_Pricing_Band
AS
SELECT
    kr.cdate                                AS cdate,
...
-- Zepto_Pricing_Band with all historical data.
-- The MV handles new inserts automatically going forward.
-- ============================================================

INSERT INTO Zepto_Pricing_Band
SELECT
    kr.cdate                                AS cdate,
    kr.keywordid                            AS keywordid,
    kr.productid                            AS productid,
