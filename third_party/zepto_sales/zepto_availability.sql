...
--
-- Source: ZeptoProductMerchant_daily  ×  Zepto_Merchant_Weight
-- ============================================================

CREATE TABLE IF NOT EXISTS Zepto_Availability
(
    cdate                  Date,
    productid              String,
    brandid                String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Zepto_Availability_MV
TO Zepto_Availability
AS
