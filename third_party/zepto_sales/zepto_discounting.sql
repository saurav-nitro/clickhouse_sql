...
--
-- Source: ZeptoProductMerchant_daily × Zepto_Merchant_Weight × UnitWeight
-- ============================================================
...
CREATE TABLE IF NOT EXISTS Zepto_Discounting
(
    cdate                  Date,
    productid              String,
    cityname               String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Zepto_Discounting_MV
TO Zepto_Discounting
AS
...
-- Zepto_Discounting with all historical data.
-- The MV handles new inserts automatically going forward.
-- ============================================================

INSERT INTO Zepto_Discounting
WITH merchant_weights AS (
    SELECT
        merchantid,
        categoryid,
