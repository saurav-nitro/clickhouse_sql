-- ============================================================
-- Zepto_Merchant_Weight
-- Merchant's share of daily/weekly sales within each
-- (cdate, categoryid, subcategoryid) bucket.
-- Source: Zepto_Sales_Weekly
-- ============================================================

CREATE TABLE IF NOT EXISTS Zepto_Merchant_Weight
(
    cdate                  Date,
    merchantid             String,
    categoryid             String,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS Zepto_Merchant_Weight_MV
TO Zepto_Merchant_Weight
AS
...
-- Zepto_Merchant_Weight with all historical data from
-- Zepto_Sales_Weekly. The MV will handle new inserts
-- going forward automatically.
-- ============================================================

INSERT INTO Zepto_Merchant_Weight
WITH category_sales AS (
    SELECT
        cdate,
        categoryid,
